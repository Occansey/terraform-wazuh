...
| Agent 2 | `t2.micro` | Web and malware host: Apache, YARA scanning |
...
Each host is bootstrapped through its `scripts/*_init.sh` user-data script, with no manual configuration.
...
- **Authentication and brute-force**: SSH and web auth failure correlation
